...
Before using this skeleton, read `references/b-skills/runtime-contract.md` §2 and §8. New saved plans include durable frontmatter before the Markdown body. Use the path and slug conventions to save the file with an English `<plan-file-slug>` filename, while frontmatter `slug` stays the canonical `<task-slug>`.
...
**Scope:** <files or area>
**Risk:** <trivial | low>   (after reading `references/b-skills/runtime-contract.md` §3)
...
- **Revise in place** when the goal, touch points, and most steps survive. Read `references/b-skills/runtime-contract.md` §2 before applying the revision protocol.
